...
for i in range(config.num_params):
    ...
    plt.savefig(f"./data/raw_data/time_info/out_12W/params{i}.png")
...
for i in range(config.num_params):
    ...
    with open(os.path.join("./data/raw_data/time_info/out_12W", f"time{i}.txt"), mode="w", encoding="utf-8") as f:
        time_str = []
